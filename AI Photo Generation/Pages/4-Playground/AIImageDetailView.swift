...
//                        .padding(.horizontal)
    ...
    private func generate() {
        ...
        // Create a placeholder image (1x1 pixel transparent image)
        // The API requires an image parameter, even for text-to-image generation
        ...
        let taskId = notificationManager.startBackgroundGeneration(
            ...
            userId: userId,
            onImageGenerated: { [weak notificationManager] generatedImage in
